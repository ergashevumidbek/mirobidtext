          ...
          <div class="card-header pb-0">
            <div class="d-flex">
              <div class="flex-grow-1">
                ...
                <p class="square-after f-w-600 header-text-primary">Yangiliklar<i class="fa fa-circle"> </i></p>
                <h4>{{$mirobid_news}}</h4>
              </div>
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card o-hidden product-widget">
          <div class="card-header pb-0">
            <div class="d-flex">
              <div class="flex-grow-1">
                <p class="square-after f-w-600 header-text-success"> Mahsulotlar <i class="fa fa-circle"> </i></p>
                <h4>{{$mirobid_pro}}</h4>
              </div>
              <div class="d-flex static-widget">
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card o-hidden message-widget">
          <div class="card-header pb-0">
            <div class="d-flex">
              <div class="flex-grow-1">
                <p class="square-after f-w-600 header-text-secondary">Galeriya rasmlari<i class="fa fa-circle"> </i></p>
                <h4>{{$gallery}}</h4>
              </div>
              <div class="d-flex static-widget">
      ...
      <div class="col-sm-6 col-lg-3">
        <div class="card o-hidden user-widget">
          <div class="card-header pb-0">
            <div class="d-flex">
              <div class="flex-grow-1">
                <p class="square-after f-w-600 header-text-info">Hodimlar<i class="fa fa-circle"> </i></p>
                <h4>{{$staff}}</h4>
              </div>
              <div class="d-flex static-widget">
